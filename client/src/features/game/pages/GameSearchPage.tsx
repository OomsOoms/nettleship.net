        ...
        <MainLayout>
            <div className="game-search-container">
                <div className="header-section">
                    <div className="controls-container">
                        ...
                        <div className="button-container">
                            <Button onClick={() => checkGame(inputtedGameCode)} disabled={!inputtedGameCode} className="button">
                                Join Game
                            </Button>
                ...
                <div className="content-section">
                    <GameFilters filters={filters} handleChange={handleChange} refresh={refresh} />
