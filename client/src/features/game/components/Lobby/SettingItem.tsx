...
function SettingItem({ title, description, value, options, isToggle = false, onChange, disabled }: SettingItemProps) {
                ...
                <>
                    ...
                    {isToggle ? (
                        ...
                        <Select
                            ...
                            onChange={(selectedValue) => onChange && onChange(title, selectedValue)}
                            disabled={disabled}
                        />
                    )}
                </>
