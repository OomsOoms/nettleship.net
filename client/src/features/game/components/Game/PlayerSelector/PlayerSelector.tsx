...
const PlayerSelector = ({ players, handlePlayerSelect }: PlayerSelectorProps) => {
    return (
        <div className="player-selector">
            ...
            <div className="selector-content">
                <div className="player-list">
                    {players.map((player) => (
                        <button key={player.userId} className="player-button" onClick={() => handlePlayerSelect(player.userId)}>
