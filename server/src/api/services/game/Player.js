class Player {
    ...
    play(game) {
        ...
        if (game.sevensAndZeros && card.score === 7) {
            ...
            const targetPlayer = players.reduce((minPlayer, player) =>
                player.hand.length < minPlayer.hand.length ? player : minPlayer
                , players[0]);
...
class AIPlayer extends Player {
    ...
    static generateName() {
        const firstNames = [
            "Walter", "Jesse", "Tony", "Bruce", "Frodo", "Arthur", "Sherlock", "Hannibal", "Mario", "Darth",
            "Luke", "Indiana", "Bilbo", "Vincent", "Don", "Rick", "Morty", "Jon", "Arya", "Neo",
            "James", "Emily", "Michael", "Sarah", "David", "Emma", "John", "Olivia", "Daniel", "Sophia",
            "Alice", "Bob", "Charlie", "David", "Eve", "Grace", "Henry", "Isabella", "Jack", "Liam"
        ];

        const lastNames = [
            "White", "Pinkman", "Stark", "Wayne", "Baggins", "Dent", "Holmes", "Lecter", "Mario", "Vader",
            "Skywalker", "Jones", "Baggins", "Vega", "Corleone", "Sanchez", "Smith", "Lannister", "Targaryen",
            "Anderson", "Brown", "Taylor", "Wilson", "Moore", "Clark", "Jackson", "Lee", "Martin", "Thompson",
            "Harris", "Garcia", "Miller", "Davis", "Roberts", "Adams", "Nelson"
        ];
